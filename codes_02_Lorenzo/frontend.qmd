...
```{rosmose display ct, fig.cap="coolingtower-visualize", out.height="80%"}
...
```{rosmose display fridge, fig.cap="refrigeration-visualize", out.height="80%"}
: OSMOSE DISPLAY_ET refrigerator
```

```{rosmose display hp, fig.cap="heatpump-visualize", out.height="80%"}
...
! OSMOSE SOLVE-LOCAL brewery TotalCost [breweryprocess, coolingtower, market, furnace, refrigerator, heatpump, cogen]
...
```{r, eval=T}
library(jsonlite)
pfilename<-"result/brewery-115.json"
