...
The various economic costs (OPEX, CAPEX, and TOTEX) along with the size of each technology resulting from this optimization are presented in the following Table. The costs associated with the boiler are zero, and likewise, the CAPEX for the Cooling Tower is also zero.
...
The various economic costs (OPEX, CAPEX, and TOTEX) along with the size of each technology resulting from this optimization are presented in the following Table. The costs associated with the boiler are zero, and likewise, the CAPEX for the Cooling Tower is also zero. Compared to the case without Rivella and Digester the size of the used cogeneration engine technollogy got increased.
...
The various economic costs (OPEX, CAPEX, and TOTEX) along with the size of each technology resulting from this optimization are presented in the following Table. The costs associated with the boiler are zero, and likewise, the CAPEX for the Cooling Tower is also zero. The contributions of each technology are similar to the case without Rivella and Digester. 
