...
#        'Heat (kW)': [cold_utilities1, hot_utilities1, cold_utilities1+hot_utilities1, np.round(upper_bound1 - lower_bound1, 2)]}
...
Since the costs are the driving factors for the comparison of the different options, the following Table summarizes the the total OPEX, CAPEX, TOTEX and ENVEX costs for the base case (without Rivalla&Digester), for the case only with Rivella, for the case only with Digester and for the case with Rivella and Digester. For a graphical representation the costs for each case are plotted in the following Figure.
