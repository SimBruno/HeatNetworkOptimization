...
The economic costs along with the size of each technology resulting from this optimization of the case with Rivella are presented in the following Table.  Compared to the case without Rivella and Digester the size of the used cogeneration engine technollogy got increased.
