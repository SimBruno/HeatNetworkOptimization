...
L_past2_1=m_milk*Cp_raw_milk*((T_past_a-T_milk_0)-T_a*math.log(T_past_a/T_milk_0)) #Question which m and cp
L_past2_2=m_milk*Cp_raw_milk*((T_past_c-T_past_b)-T_a*math.log(T_past_c/T_past_b))#Question which m and cp
...
L_past4_1=m_milk*Cp_raw_milk*((T_milk-T_past_d)-T_a*math.log(T_milk/T_past_d))

L_gy_past4=m_gly_past4*Cp_glywater*((T_milk-T_past_d)-T_a*math.log(T_milk/T_past_d))#glywater temperature

L_past4=L_past4_1+L_gy_past4
#print(L_past4)

#Past 5
L_past5_1=m_int*Cp_cream*((T_crpast_a-T_cream)-T_a*math.log(T_crpast_a/T_cream))
L_past5_2=m_cream*Cp_cream*((T_crpast_c-T_crpast_b)-T_a*math.log(T_crpast_c/T_crpast_b))
...
L_mixer_2=m_thick*Cp_alboline*((T_crpast_x-T_thick)-T_a*math.log(T_thick/T_thick))
