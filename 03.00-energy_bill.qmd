...
The amount of exergy that is lost in the pasteurization process is calculated b adding all the exergy losses of the heat exchangers. 
$$
...
df = read.csv('atom_balance_copy.csv',sep = '\t') # replace the atom_balance.csv with your exergy analysis results
