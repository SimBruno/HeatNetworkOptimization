...
L_gy_ref=m_gly_ref*Cp_glywater*((Delta_T_Gly)-T_a*math.log(T_fmilk/T_mixure_out))#glywater temperature
...
L_past3_1=m_milk*Cp_raw_milk*((T_past_b-T_past_a)-T_a*math.log(T_past_b/T_past_a))
...
L_mixer_2=m_thick*Cp_alboline*((T_crpast_x-T_thick)-T_a*math.log(T_crpast_x/T_thick))
