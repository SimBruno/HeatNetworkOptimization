...
To evaluate the losses and inefficiencies of the dairy production an exergy analysis is carried out. The ambient temperature is assumed to be $T_0 = 20°C + 273K = 293K$. 
...
#### Splitter
$$\dot{L}_{splitter}=\dot{m}_{in}(h_{in}-T_{0}s_{in})-\dot{m}_{out}(h_{out}-T_{0}s_{out})$$
