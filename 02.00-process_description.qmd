...
In this subsection are indicated the heat flows equations of each elements for the pasteurisation. All variables are defined whether on the pasteurization scheme or in the mass flow or heat capacities sections.
...
T_out = T_in - 5
T0 = 25+273
delta_s3 = Cp_steam*np.log(T_in/T_out)
delta_h3= Cp_steam*(T_in-T_out)
delta_s6= Cp_steam*np.log(T_in/T_out)
delta_h6 = Cp_steam*(T_in-T_out)
...
Variables_Names = ['delta_s3','delta_s6']
Variables_Values = [delta_s3,delta_s6]
...
Variables_Names = ['delta_h3','delta_h6']
Variables_Values = [delta_h3,delta_h6]
...
df_6_variable =  pd.DataFrame(data = {'Variable' : ['delta_s3','delta_s6']})
df_6_values = df_pasteurization_entropy['Value']
df_6 = pd.concat([df_6_variable,df_6_values], axis = 1)

df_7_variable =  pd.DataFrame(data = {'Variable' : ['delta_h3','delta_h6']})
...
```{python test, echo = T, eval = T}
State_Cold=mixture(T=333, P=100000, frac_water=0.65, frac_fat=0.35)
print(State_Cold)

State_Hot=mixture(T=348, P=100000, frac_water=0.65, frac_fat=0.35)
print(State_Hot)
```