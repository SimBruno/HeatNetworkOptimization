...
### Heating Demand of Evaporators

NOTE: afficher mass flow, temperature, pression pour les points 6, 7, 8, 9, 10, 11, 14, 15, 16, 17, 18
...
data = {'Point': ['6', '7', '8', '9', '10', '11', '14', '15', '16', '17', '18'],
        'Mass flow (kg/s)': [m6, m7, m8, m9, m10, m11, m14, m15, m16, m17, m18],
        'Temperature (K)': [T6, T7, T8, T9, T10, T11, T14, T15, T16, T17, T18],
        'Pressure (Pa)': [p6, p7, p8, p9, p10, p11, p14, p15, p16, p17, p18]}
df = pd.DataFrame(data)
df = df.set_index('Point')
df = df.round(4)
HTML(df.to_html())
