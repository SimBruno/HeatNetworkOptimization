...
| $\dot m_{gly,ref}$ | `r m_gly_ref` |kg/s|
| $\dot m_{steam,past3}$ | `r m_steam_past3` |kg/s|
| $\dot m_{gly,past4}$ | `r m_gly_past4` |kg/s|
| $\dot m_{steam,past6}$ | `r m_steam_past6` |kg/s|
| $\dot m_{gly,past7}$ | `r m_gly_past7` |kg/s|
