...
In this section, the task is to compute the thermodynamic properties of all the streams within each section of the dairy factory. The sections that are going to be analyzed are the following:
...
Therefore to solve in -a hopefully more original- a convenient way this issue, it is assumed a steam flow can be added to make e20 reach a certain value such that $T_{cold,in}<T_{hot,out}$ in the HX3. 
