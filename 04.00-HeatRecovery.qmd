...
#####
def Dtmin(dT, T1, T1v, T2v, T2, m2, cp2, position, pastnb):
...
for t in dt_5:
    CAPEX_5, OPEX_fr_5, OPEX_ger_5, TOTEX_fr_5, TOTEX_ger_5, Area_5 = Dtmin(t, T1_5, T1v_5, T2v_5, T2_5, m2_5, cp2_5, 'right', 5)
...
for t in dt_1:
    CAPEX_1, OPEX_fr_1, OPEX_ger_1, TOTEX_fr_1, TOTEX_ger_1, Area_1 = Dtmin(t, T1_1, T1v_1, T2v_1, T2_1, m2_1, cp2_1, 'left', 1)
...
dtmin_opt_1_fr = dt_1[min_index_fr_1]
dtmin_opt_1_ger = dt_1[min_index_ger_1]
area_opt_1_fr = Areav_1[min_index_fr_1]
area_opt_1_ger = Areav_1[min_index_ger_1]
CAPEX_opt_1_fr = CAPEXv_1[min_index_fr_1]
CAPEX_opt_1_ger = CAPEXv_1[min_index_ger_1]
...
Past1_opt_fr = pd.DataFrame({'dTmin_fr[K]': dtmin_opt_1_fr, 'Area_fr[m^2]': area_opt_1_fr, 'CAPEX_fr[€/yr]': CAPEX_opt_1_fr, 'OPEX_fr[€/yr]': OPEX_fr_opt_1, 'TOTEX_fr[€/yr]': TOTEX_fr_opt_1}, index=[0])
Past1_opt_fr = Past1_opt_fr.round(2)
HTML(Past1_opt_fr.to_html(index=False))

Past1_opt_ger = pd.DataFrame({'dTmin_ger[K]': dtmin_opt_1_ger, 'Area_ger[m^2]': area_opt_1_ger, 'CAPEX_ger[€/yr]': CAPEX_opt_1_ger, 'OPEX_ger[€/yr]': OPEX_ger_opt_1, 'TOTEX_ger[€/yr]': TOTEX_ger_opt_1}, index=[0])
Past1_opt_ger = Past1_opt_ger.round(2)
HTML(Past1_opt_ger.to_html(index=False))
```

```{python past1+5_plot, echo = F, eval = F}	
