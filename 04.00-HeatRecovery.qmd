...
First, in task 4, optimization of the minimum temperature difference ($\DeltaT$) in heat exchangers, will be performed. The goal will be to see if in 2 processes (namely Pasteurization and Cleaning In Place), it is possible to optimize the $\DeltaT_{min}$ of some of the HX to reduce the energy bill. 
