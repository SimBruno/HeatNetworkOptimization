...
```{python testmixture, echo = T, eval = T}
import matplotlib
matplotlib.use('Agg')
import numpy as np
import pandas as pd
...
State_Cold_1_2 = mixture(T=T1_2, P=p1_2, frac_water=0.883, frac_fat=0.117)
State_Cold_2_2 = mixture(T=T2_2, P=p1_2, frac_water=0.883, frac_fat=0.117)

h1_2 = State_Cold_1_2["enthalpy"] * m1_2  #from mixture with dry = 11.7% and wet = 88.3%
h2_2 = State_Cold_2_2["enthalpy"] * m2_2

cp1_2 = State_Cold_1_2["cpmass"]
cp2_2 = State_Cold_2_2["cpmass"]

print(m1_2*cp1_2, m2_2*cp2_2)
