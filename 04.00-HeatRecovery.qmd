...
```{r}
library(jsonlite)
pfilename<-"codes_02_heat_recovery/result/brewery-21.json"
...
file_name = open('codes_02_heat_recovery/result/brewery-21.json')
...
plt.axvline(x=16508.95225, color="green", linestyle="--", alpha = 0.5)
plt.axvline(x=2131.654373, color="green", linestyle="--", alpha = 0.5)
