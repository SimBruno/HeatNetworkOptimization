...
water is in closed loop -> capex (but small compared to the heat exchanger cost so we neglect it)

heating: $$c_{gas} \cdot Q_{HEX} \cdot t_{op}$${#eq-heating}
assumption: $\eta_{boiler} = 1$

cooling: $$c_{elec} \cdot \frac{Q_{HEX}}{COP} \cdot t_{op}$${#eq-cooling}
