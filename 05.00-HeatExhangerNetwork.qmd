...
- HU2 is placed after all splitting of D and $Q_{HU2} = Q_{D} - Q_{E5} = 9.7 kW$

- HU3 is placed after all splitting of F and $Q_{HU3} = Q_{F} - Q_{E1} = 167.5 kW$

Let's now continue with the design below the pinch point (recall $T_{pinch}=67.5°C$).



ILLUSTRATION WITH ALL EXCHANGERS

COMMENTS ON THE E9 and E10 EXCHANGERS which are impossible

REOVE E9 AND E10 FROM ECONOMIC ANALYSIS
