...
elec_cost = 0.12 [Euro/kWh] # price of electricity for businesses in Switzerland 2023 (Oiken)
ELEC_ref_POWER = 1000 [kW] # Reference capacity of electricity supply
natgas_cost = 0.08 [Euro/kWh] # price of natural gas for businesses in Switzerland (globalpetrolprices.com)
...
RIVELLA_BUY_COST = -1*%rivella_price% * %RIVELLA_ref_LOAD% [Euro/h] # Reference price of rivella purchased by the market from the process
...
```{rosmose RivellaBuy_params}
: OSMOSE UNIT_PARAM RivellaBuy

|cost1  |cost2                |cinv1  |cinv2  |imp1   |imp2   |fmin   |fmax   |
|:------|:--------------------|:------|:------|:------|:------|:------|:------|
|0      |%RIVELLA_BUY_COST%   |0      |0      |0      |0      |0      |1000   |
```
...
```{rosmose RivellaBuy_rs}
: OSMOSE RESOURCE_STREAMS RivellaBuy

|layer     |direction  |value                   |
|:---------|:----------|:-----------------------|
|RIVELLA   |in         |%RIVELLA_ref_LOAD%      |
```
